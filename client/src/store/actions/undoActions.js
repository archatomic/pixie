...
export const UNDO_RESTORE = 'undo.restore'
export const UNDO = 'undo.undo'

export const undo = (record, steps) =>
{
    action(UNDO, { record, steps })
    action(UNDO_RESTORE, record)
}

export const REDO = 'undo.redo'
export const redo = (record, steps) =>
{
    action(REDO, { record, steps })
    action(UNDO_RESTORE, record)
}
